...
/**
 * String-keyed alias dictionary for bone name → Epic Fight joint resolution.
 * Lives separately from {@link FighturaJointMap} so it can be unit-tested
 * without Figura/Epic Fight classes on the test classpath.
 */
public final class BoneAliasTable {
    ...
    static {
        ...
        // Figura ParentType wearables
        put(m, "Cape", "Chest");
        put(m, "LeftElytra", "Chest");
        put(m, "RightElytra", "Chest");
        put(m, "LeftItemPivot", "Hand_L");
        put(m, "RightItemPivot", "Hand_R");
        put(m, "HelmetItemPivot", "Head");
        put(m, "LeftSpyglassPivot", "Head");
        put(m, "RightSpyglassPivot", "Head");
        put(m, "LeftParrotPivot", "Arm_L");
        put(m, "RightParrotPivot", "Arm_R");
        ...
        // Common English bone names (arms)
        ...
        // Common English bone names (legs)
    ...
    private BoneAliasTable() {
    }

    public static String resolve(String alias, UUID owner) {
        if (alias == null) {
            return null;
        }
